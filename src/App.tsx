...
const DashboardView = lazy(() =>
  import("@/features/dashboard/dashboard-view").then((m) => ({
...
const NotesView = lazy(() =>
  import("@/features/notes/notes-view").then((m) => ({ default: m.NotesView })),
);
...
export function App() {
  ...
  useEffect(() => {
    ...
    ;(window as any).appShellStore = useAppShellStore;
  }, []);
